...
define("EW_PROJECT_NAME", "maoridb", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{FF0DFD12-B2E5-4AC7-8EC9-50E29151819F}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'oFGspR5pS3Y85qkW', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/maoridb.css", TRUE); // Project stylesheet file name
...
define("EW_ADMIN_PASSWORD", "4qasshole", TRUE); // Administrator password
