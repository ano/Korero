...
$words_grid = NULL; // Initialize page object first

class cwords_grid extends cwords {
	...
	// Page object name
	var $PageObjName = 'words_grid';

	// Grid form hidden field names
	var $FormName = 'fwordsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["words"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_maori") && $objForm->HasValue("o_maori") && $this->maori->CurrentValue <> $this->maori->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_english") && $objForm->HasValue("o_english") && $this->english->CurrentValue <> $this->english->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_dialects_id") && $objForm->HasValue("o_dialects_id") && $this->dialects_id->CurrentValue <> $this->dialects_id->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->maori->setOldValue($objForm->GetValue("o_maori"));
		...
		$this->dialects_id->setOldValue($objForm->GetValue("o_dialects_id"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "dialects") {
			$this->dialects_id->Visible = FALSE;
			if ($GLOBALS["dialects"]->EventCancelled) $this->EventCancelled = TRUE;
		}
