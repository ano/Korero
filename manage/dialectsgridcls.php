...
$dialects_grid = NULL; // Initialize page object first

class cdialects_grid extends cdialects {
	...
	// Page object name
	var $PageObjName = 'dialects_grid';

	// Grid form hidden field names
	var $FormName = 'fdialectsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["dialects"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_language_id") && $objForm->HasValue("o_language_id") && $this->language_id->CurrentValue <> $this->language_id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_dialects") && $objForm->HasValue("o_dialects") && $this->dialects->CurrentValue <> $this->dialects->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->dialects->setOldValue($objForm->GetValue("o_dialects"));
	}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "_language") {
			...
			if ($GLOBALS["_language"]->EventCancelled) $this->EventCancelled = TRUE;
		}
