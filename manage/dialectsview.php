...
$dialects_view = NULL; // Initialize page object first

class cdialects_view extends cdialects {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "dialectslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "dialectslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "dialectslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		// Detail table 'words'
		$body = $Language->TablePhrase("words", "TblCaption");
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("wordslist.php?" . EW_TABLE_SHOW_MASTER . "=dialects&id=" . strval($this->id->CurrentValue) . "") . "\">" . $body . "</a>";
		$item = &$option->Add("detail_words");
		$item->Body = $body;
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("words", $DetailTblVar)) {
				...
				if ($GLOBALS["words_grid"]->DetailView) {
					$GLOBALS["words_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($dialects_view)) $dialects_view = new cdialects_view();

// Page init
$dialects_view->Page_Init();

// Page main
$dialects_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$dialects_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var dialects_view = new ew_Page("dialects_view");
dialects_view.PageID = "view"; // Page ID
var EW_PAGE_ID = dialects_view.PageID; // For backward compatibility

// Form object
var fdialectsview = new ew_Form("fdialectsview");

// Form_CustomValidate event
fdialectsview.Form_CustomValidate = 
...
fdialectsview.ValidateRequired = true;
<?php } else { ?>
fdialectsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdialectsview.Lists["x_language_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x__language","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $dialects_view->ExportOptions->Render("body") ?>
<?php if (!$dialects_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($dialects_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $dialects_view->ShowPageHeader(); ?>
<?php
$dialects_view->ShowMessage();
?>
<form name="fdialectsview" id="fdialectsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="dialects">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_dialectsview" class="table table-bordered table-striped">
...
<?php if ($dialects->language_id->Visible) { // language_id ?>
	<tr id="r_language_id">
		<td><span id="elh_dialects_language_id"><?php echo $dialects->language_id->FldCaption() ?></span></td>
...
<?php if ($dialects->dialects->Visible) { // dialects ?>
	<tr id="r_dialects">
		<td><span id="elh_dialects_dialects"><?php echo $dialects->dialects->FldCaption() ?></span></td>
...
<?php
	if (in_array("words", explode(",", $dialects->getCurrentDetailTable())) && $words->DetailView) {
?>
